...
@WebService(endpointInterface = "org.chrisferdev.webapp.jaxws.services.ServicioWs")
public class ServicioWsImpl implements ServicioWs{
    ...
    public List<Curso> listar() {
        return Arrays.asList(new Curso("java"), new Curso("spring"), new Curso("jakartaa ee"));
    }
